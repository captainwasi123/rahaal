  ...
  <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li><a href="{{route('about')}}"  class="{{!empty($nav) && $nav == 'about' ? 'active' : ''}}">ABOUT</a></li>
        <li class="dropdown"><a href="{{route('vlogs')}}" class="{{!empty($nav) && $nav == 'episodes' ? 'active' : ''}}">VLOGS <i class="bi bi-chevron-down toggle-dropdown"></i></a>
          <ul>
        ...
        <li><a href="{{route('collaborate')}}"  class="{{!empty($nav) && $nav == 'collaborate' ? 'active' : ''}}">COLLABOLATE</a></li>
        <li><a href="{{route('reach-out')}}"  class="{{!empty($nav) && $nav == 'contact' ? 'active' : ''}}">REACH OUT</a></li>
      </ul>

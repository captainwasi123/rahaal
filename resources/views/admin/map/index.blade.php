            ...
            <div class="card-header">
              <div class="row">
                <div class="col-md-9 searchbar">
                  <input type="text" name="retailer" placeholder="Search for Location..." class="form-control searchBlog">
...
<div class="modal fade" id="addBlogFormModal">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="add_blog_form" action="{{route('admin.map.create')}}">
        @csrf
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-4 blog-img-alt">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="img_date" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Album</label>
                <input type="file" class="form-control album-file" name="album[]" multiple required>
              </div>
            </div>
          </div>
              <br><br>
...
<script>
  ...
  function loadBlogs() {
    ...
    $pu = ($pu == 0 ? '' : '?page='.$pu);
    @endphp
    var url = "{{route('admin.map.load').$pu}}";
